Contributing to RUPEE coin Core
==================================

The RUPEE coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the RUPEE coin Core project, and is not to be
confused with overall RUPEE coin Network Protocol consensus changes.

Whether a pull request is merged into RUPEE coin Core rests with the project merge
...
Patches that change RUPEE coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the RUPEE coin consensus, it must have been
...
The project leader is the release manager for each RUPEE coin Core release.
