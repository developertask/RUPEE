...
This mechanism has been integrated into Bitcore-Node-RUPcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rupeecoin/insight-api-rupeecoin#web-socket-api](https://github.com/rupeecoin/insight-api-rupeecoin#web-socket-api)
* API: [https://github.com/rupeecoin/insight-api-rupeecoin#swifttx-transactions](https://github.com/rupeecoin/insight-api-rupeecoin#swifttx-transactions)
...
By default, the RUPEE coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the RUPEE coin Core daemon:
