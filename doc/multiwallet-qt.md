...
In order to support loading of multiple wallets in rupeecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rupeecoin.cpp.
...
Changes to rupeecoin.cpp
----------------------
rupeecoin.cpp is the entry point into rupeecoin-qt, and as such, will require some minor modifications to provide hooks for
