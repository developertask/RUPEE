...
RUPEE coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<rupeecoin_address\> \<monthly_payment_rupeecoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ RUP, _12_ times over the course of a year totaling _24000_ RUP.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<rupeecoin_address\> \<monthly_payment_rupeecoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` RUP.
 ...
 * vote-many          - Vote on a RUPEE coin initiative
 * vote-alias         - Vote on a RUPEE coin initiative
 * vote               - Vote on a RUPEE coin initiative/budget
