...
#   c) node1 mines 32 blocks, so now node 0 has 500000RUP, node 1 has 4250RUP, node2 has none.
#   d) node0 sends 601 RUP to node2, in two transactions (301 RUP, then 300 RUP).
