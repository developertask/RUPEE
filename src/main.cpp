...
#if defined(NDEBUG)
#error "RUPEE coin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in urup) are considered zero fee (for relaying and mining)
...
{
    RenameThread("rupeecoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // RUP: We use certain sporks during IBD, so check to see if they are
