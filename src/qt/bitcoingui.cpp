...
//---
// Copyright (c) 2017-2017 The RUPEE coin developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("RUPEE coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RUP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rupeecoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About RUPEE coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about RUPEE coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RUPEE coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RUP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RUP addresses"));
    ...
    openAction->setStatusTip(tr("Open a rupeecoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RUPEE coin Core help message to get a list with possible RUPEE coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("RUPEE coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RUPEE coin network", "", count));
}
...
{
    QString strTitle = tr("RUPEE coin Core"); // default title
