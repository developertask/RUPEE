...
/* RUPEE coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "RUPcoin"
#define QAPP_ORG_DOMAIN "savebitcoin.io"
#define QAPP_APP_NAME_DEFAULT "RUPcoin-Qt"
#define QAPP_APP_NAME_TESTNET "RUPcoin-Qt-testnet"
