...
/** Utility functions used by the RUPcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render RUP addresses in monospace font
...
// Parse "rupeecoin:" URI into recipient object, return true on successful parsing
