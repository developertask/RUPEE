...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("RUPEE coin Core"),
     ...
     * override -datadir in the rupeecoin.conf file in the default data directory
     * (to be consistent with rupeecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
