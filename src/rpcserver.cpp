...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop RUPEE coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "RUPEE coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RUPEE coin features */
        {"rupeecoin", "masternode", &masternode, true, true, false},
        {"rupeecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"rupeecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"rupeecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"rupeecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"rupeecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"rupeecoin", "startmasternode", &startmasternode, true, true, false},
        {"rupeecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"rupeecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"rupeecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"rupeecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"rupeecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"rupeecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"rupeecoin", "mnbudget", &mnbudget, true, true, false},
        {"rupeecoin", "preparebudget", &preparebudget, true, true, false},
        {"rupeecoin", "submitbudget", &submitbudget, true, true, false},
        {"rupeecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"rupeecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"rupeecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"rupeecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"rupeecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"rupeecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"rupeecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"rupeecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"rupeecoin", "mnsync", &mnsync, true, true, false},
        {"rupeecoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> rupeecoin-cli " + methodname + " " + args + "\n";
}
