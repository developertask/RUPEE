/* src/config/rupeecoin-config.h.  Generated from rupeecoin-config.h.in by configure.  */
/* src/config/rupeecoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "RUPEE coin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "RUPEE coin Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rupeecoin"
