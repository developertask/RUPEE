...
pkgdatadir = $(datadir)/rupeecoin
pkgincludedir = $(includedir)/rupeecoin
pkglibdir = $(libdir)/rupeecoin
pkglibexecdir = $(libexecdir)/rupeecoin
...
CONFIG_HEADER = $(top_builddir)/src/config/rupeecoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/rupeecoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/ubuntu/rupeecoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/ubuntu/rupeecoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ubuntu/rupeecoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ubuntu/rupeecoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = rupeecoin-cli
BITCOIN_DAEMON_NAME = rupeecoind
BITCOIN_GUI_NAME = rupeecoin-qt
BITCOIN_TX_NAME = rupeecoin-tx
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /home/ubuntu/rupeecoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
PACKAGE_NAME = RUPEE coin Core
PACKAGE_STRING = RUPEE coin Core 1.1.0
PACKAGE_TARNAME = rupeecoin
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/ubuntu/rupeecoin
abs_srcdir = /home/ubuntu/rupeecoin
abs_top_builddir = /home/ubuntu/rupeecoin
abs_top_srcdir = /home/ubuntu/rupeecoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ubuntu/rupeecoin/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_rupeecoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_rupeecoin_coverage.info test_rupeecoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/RUPcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/rupeecoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/rupeecoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/rupeecoin-config.h
$(top_srcdir)/src/config/rupeecoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/rupeecoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/RUPcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/RUPcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/RUPcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_rupeecoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_rupeecoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_rupeecoin_filtered.info: test_rupeecoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_rupeecoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_rupeecoin_coverage.info: baseline_filtered_combined.info test_rupeecoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_rupeecoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_rupeecoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_rupeecoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_rupeecoin.coverage/.dirstamp:  test_rupeecoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_rupeecoin.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_rupeecoin.coverage/ total.coverage/ $(OSX_APP)
