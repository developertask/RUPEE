...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/rupeecoin-cli.cpp \
           src/rupeecoin-tx.cpp \
           src/rupeecoin.cpp \
           src/db.cpp \
           ...
           src/qt/rupeecoin.cpp \
           src/qt/rupeecoinstrings.cpp \
...
RESOURCES += src/qt/rupeecoin.qrc src/qt/rupeecoin_locale.qrc

TRANSLATIONS += src/qt/locale/rupeecoin_bg.ts \
                src/qt/locale/rupeecoin_de.ts \
                src/qt/locale/rupeecoin_en.ts \
                src/qt/locale/rupeecoin_es.ts \
                src/qt/locale/rupeecoin_fi.ts \
                src/qt/locale/rupeecoin_fr.ts \
                src/qt/locale/rupeecoin_it.ts \
                src/qt/locale/rupeecoin_ja.ts \
                src/qt/locale/rupeecoin_pl.ts \
                src/qt/locale/rupeecoin_pt.ts \
                src/qt/locale/rupeecoin_ru.ts \
                src/qt/locale/rupeecoin_sk.ts \
                src/qt/locale/rupeecoin_sv.ts \
                src/qt/locale/rupeecoin_vi.ts \
                src/qt/locale/rupeecoin_zh_CN.ts \
                src/qt/locale/rupeecoin_zh_TW.ts
